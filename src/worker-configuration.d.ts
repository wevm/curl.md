/* eslint-disable */
// Generated by Wrangler by running `wrangler types src/worker-configuration.d.ts` (hash: 46a839c13b1555b6a45793ccd2a07e7a)
// Runtime types generated with workerd@1.20260317.1 2025-10-30 no_handle_cross_request_promise_resolution,nodejs_compat
declare namespace Cloudflare {
	...
	interface Env {
		...
		GH_API_URL: "https://api.github.com";
		GH_URL: "https://github.com";
		HOST: "curl.md" | "__PREVIEW_APEX__.curl.md" | "curl.local";
		CLOUDFLARE_ACCOUNT_ID: string;
		CLOUDFLARE_API_TOKEN: string;
		COOKIE_SECRET: string;
		GH_CLIENT_ID: string;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "GH_API_URL" | "GH_URL" | "HOST" | "CLOUDFLARE_ACCOUNT_ID" | "CLOUDFLARE_API_TOKEN" | "COOKIE_SECRET" | "GH_CLIENT_ID" | "GH_CLIENT_SECRET" | "STRIPE_PUBLISHABLE_KEY" | "STRIPE_SECRET_KEY" | "STRIPE_WEBHOOK_SECRET" | "SENTRY_DSN" | "TOKEN_ENCRYPTION_KEY">> {}
}
