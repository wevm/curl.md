...
Optionally log in to unlock higher usage limits and features, like [objective extraction](/docs/guide/features#objective-based-narrowing).
...
Narrow by [objective](/docs/guide/api#objective) with `--objective`:

```sh
$ md zod.dev/error-formatting --objective tree error formatting
```

Add [keywords](/docs/guide/api#keywords) with `--keywords`:
...
Choose a [mode](/docs/guide/api#mode) with `--mode`:
...
Log in from the CLI to unlock higher usage limits and features, like [objective extraction](/docs/guide/features#objective-based-narrowing).
...
Register as MCP server (add, doctor)

| Command                 | Description                                  |
| ----------------------- | -------------------------------------------- |
| [`add`](#mcp-add)       | Register as MCP server                       |
| [`doctor`](#mcp-doctor) | Validate MCP server startup and tool listing |
...
| [`list`](#skills-list), `ls` | List skills                |
