...
| ------- | ----------------------------------------------- | ---------------------------- | --------------------------- |
| Node.js | `pnpm add curl.md`                              | `curl.config.ts`             | Existing TypeScript apps    |
| Bun     | `bun add curl.md`                               | `bunfig.toml`                | Fast local tooling          |
| Deno    | `deno add jsr:@wevm/curl-md`                    | `deno.json`                  | URL-first workflows         |
| CI      | `pnpm dlx curl.md https://example.com/rules.md` | `.github/workflows/docs.yml` | One-off checks in pipelines |
