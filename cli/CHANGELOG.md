...
- Fixed published TypeScript SDK declarations so `createClient` retained its route-aware types for package consumers. ([#82](https://github.com/wevm/curl.md/pull/82))
...
- Updated logging ([`9079a94`](https://github.com/wevm/curl.md/commit/9079a94bc339174ff2d1c37e2a9c29bddecc1737))
